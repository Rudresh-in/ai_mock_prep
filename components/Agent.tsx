...
const Agent = ({userName, userId, type, interviewId, questions, feedbackId}: AgentProps) => {
    ...
    }, [messages, callStatus, type, userId, feedbackId, interviewId]);
            ...
            <div className="card-border">
                <div className="card-content">
                    <Image src="/user-avatar.png" alt="user avatar"
                           height={540} width={540} className="rounded-full object-cover
                        size-[120px]" />
                    <h3>{userName}</h3>
                </div>
            </div>
        ...
        <div className="w-full flex justify-center">
            {callStatus !== 'ACTIVE' ? (
                <button className="relative btn-call" onClick={() => handleCall()}>
                    <span className={cn('absolute animate-ping opacity-75',
